...
public class TestEqualUser {
    ...
    public static void main(String[] args) {
        ...
        AdditiveSecretSharing.RandomNumberTuple[] rTuples = AdditiveSecretSharing.generateRandomNumberTuples(l, mod);
...
//                BigInteger y = new BigInteger(dataBitLength, random);
                BigInteger y = (random.nextBoolean()) ? x : new BigInteger(dataBitLength, random);
